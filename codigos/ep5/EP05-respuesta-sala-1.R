...
# Pregunta 2: Si la verdadera dureza media de la línea de producción fuera 172 [kgf mm-2], 
...
# Calculo del poder usando la función power.t.test()
...
g <- g + scale_x_continuous(name = "Grafico de distribuciones")
g <- g + theme_pubr()
...
cat("poder teorico = ", poderTeorico, "\n")
cat("poder experimental = ", poderExperimental, "\n")
cat("beta teorico = ", betaTeorico, "\n")
cat("beta experimental = ", betaExperimental, "\n")

# Conclusión
# Si la verdadera media es de 172 [kgf mm-2] existe una probabilidad de que el ingeniero cometa
...
# Pregunta 3: Como no se conoce la verdadera dureza media, genere un gráfico del poder 
...
# Pregunta 4: ¿Cuántas barras deberían revisarse para conseguir un poder estadístico de 
...
sd <- 10
mediaTeorica <- 170
mediaMuestral <- 178   # Duda es 178(preg3) , 172 (preg2) o 173(preg1) ¿?
diferencia <- mediaMuestral - mediaTeorica
...
# Conclusión    (CAMBIAR DEPENDIENDO DE LA MEDIA MUESTRAL QUE SE USE)
# A través de la prueba realizada se puede concluir que se necesitan revisar 15 barras
...
# Pregunta 5: ¿Y si quisiera ser bien exigente y bajar la probabilidad de cometer un error
